...
pub fn build_square_root<'ctx, 'this>(
    ...
    let k1 = entry.const_int_from_type(context, location, 1, i16_ty)?;
    ...
    let result = entry.append_op_result(scf::r#if(
        ...
        },
        {
            ...
            let k16 = entry.const_int_from_type(context, location, 16, i16_ty)?;
            ...
            let parity_mask = block.const_int_from_type(context, location, -2, i16_ty)?;
            let shift_amount =
                block.append_op_result(arith::andi(shift_amount, parity_mask, location))?;

            let k0 = block.const_int_from_type(context, location, 0, i16_ty)?;
            let result = block.append_op_result(scf::r#while(
                ...
                &[i16_ty, i16_ty],
                {
                    ...
                    let k2 = block.const_int_from_type(context, location, 2, i16_ty)?;
...
pub fn build_from_felt252<'ctx, 'this>(
    ...
    let const_max = entry.const_int_from_type(context, location, u16::MAX, felt252_ty)?;
