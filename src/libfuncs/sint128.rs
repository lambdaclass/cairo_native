...
mod test {
    ...
    fn i128_from_felt252() {
        let program = load_cairo!(
            ...
            fn run_test() -> (Option<i128>, Option<i128>) {
                (
                    ...
                    340282366920938463463374607431768211456.try_into(),
                )
            }
        );
        ...
        run_program_assert_output(
            ...
            &[],
            &[jit_struct!(
                jit_enum!(0, 9223372036854775807i128.into()),
    ...
    fn i128_overflowing_add() {
        ...
        fn run(lhs: i128, rhs: i128) {
            ...
            let error = Felt252::from_bytes_be(b"i128_add Overflow");
    ...
    fn i128_overflowing_sub() {
        ...
        fn run(lhs: i128, rhs: i128) {
            ...
            let error = Felt252::from_bytes_be(b"i128_sub Overflow");
