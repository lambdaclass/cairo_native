...
use melior::{
    ...
    ir::{
        ...
        r#type::IntegerType,
        Block, Identifier, Location, Type, ValueLike,
    },
    Context,
};
...
pub fn build_call_contract<'ctx, 'this>(
    ...
    let entry_point_selector_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(
    ...
    let calldata_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
...
pub fn build_class_hash_try_from_felt252<'ctx, 'this>(
    ...
    let source_val = BigUint::parse_bytes(
...
pub fn build_storage_base_address_from_felt252<'ctx, 'this>(
    ...
    let value = BigUint::parse_bytes(
        b"3618502788666131106986593281521497120414687020801267626233049500247285300992",
        10,
    )
    .unwrap();
...
pub fn build_deploy<'ctx, 'this>(
    ...
    let class_hash_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(
    ...
    let contract_address_salt_arg_ptr_ty =
        llvm::r#type::pointer(IntegerType::new(context, 252).into(), 0);
    let contract_address_salt_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(
...
pub fn build_keccak<'ctx, 'this>(
    ...
    let input_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(IntegerType::new(context, 64).into(), 8).into(),
...
pub fn build_library_call<'ctx, 'this>(
    ...
    let function_selector_arg_ptr_ty =
        llvm::r#type::pointer(IntegerType::new(context, 252).into(), 0);
    let function_selector_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(
...
pub fn build_send_message_to_l1<'ctx, 'this>(
    ...
    let to_address_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(
    ...
    let payload_arg_ptr = helper.init_block().append_op_result(
        OperationBuilder::new("llvm.alloca", location)
            .add_attributes(&[(
                Identifier::new(context, "alignment"),
                IntegerAttribute::new(IntegerType::new(context, 64).into(), 8).into(),
