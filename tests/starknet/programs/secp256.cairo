use core::starknet::{
    ...
    secp256r1::{
        Secp256r1Point, secp256r1_new_syscall, secp256r1_add_syscall, secp256r1_mul_syscall,
...
fn secp256r1_new(x: u256, y: u256) -> Result<Option<Secp256r1Point>, Array<felt252>> {
    secp256r1_new_syscall(x, y)
}

fn secp256r1_add(p0: Secp256r1Point, p1: Secp256r1Point) -> Result<Secp256r1Point, Array<felt252>> {
    secp256r1_add_syscall(p0, p1)
}

fn secp256r1_mul(p: Secp256r1Point, scalar: u256) -> Result<Secp256r1Point, Array<felt252>> {
    secp256r1_mul_syscall(p, scalar)
}

fn secp256r1_get_point_from_x(
    p: u256, y_parity: bool
) -> Result<Option<Secp256r1Point>, Array<felt252>> {
    secp256r1_get_point_from_x_syscall(p, y_parity)
}

fn secp256r1_get_xy(p: Secp256r1Point) -> Result<(u256, u256), Array<felt252>> {
    secp256r1_get_xy_syscall(p)
}
