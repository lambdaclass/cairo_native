module attributes {llvm.data_layout = ""} {
  ...
  ^bb3(%10: i256, %11: i256, %12: i256):  // pred: ^bb1
    ...
    %22 = llvm.call @"fib::fib::fib"(%19, %20, %21) : (i256, i256, i256) -> i256
  ...
  ^bb3(%6: i256):  // pred: ^bb1
    ...
    %13 = llvm.call @"fib::fib::fib"(%10, %11, %12) : (i256, i256, i256) -> i256
    ...
    %17 = llvm.call @"fib::fib::fib_mid"(%16) : (i256) -> !llvm.struct<()>
    llvm.br ^bb4
  ^bb4:  // 2 preds: ^bb2, ^bb3
  ...
  ^bb1:  // pred: ^bb0
    ...
    %2 = llvm.call @"fib::fib::fib_mid"(%1) : (i256) -> !llvm.struct<()>
