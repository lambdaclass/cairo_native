...
test-cairo: check-llvm needs-cairo2
	cargo r --profile ci --package cairo-native-test -- -O2 --run-mode aot --compare-with-cairo-vm corelib
	cargo r --profile ci --package cairo-native-test -- -O2 --run-mode aot --compare-with-cairo-vm cairo/tests/bug_samples/ --starknet
	cargo r --profile ci --package cairo-native-test -- -O2 --run-mode aot --compare-with-cairo-vm cairo/crates/cairo-lang-starknet/cairo_level_tests/ --starknet
