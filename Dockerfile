...
RUN curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | bash -s -- -y --default-toolchain=nightly-2023-06-19
...
RUN cargo +nightly-2023-06-19 build --release --all-features
