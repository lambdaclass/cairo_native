...
mod tests {
    ...
    fn opaque_pointer() {
        ...
        assert_eq!(super::opaque_pointer(&context), Type::parse(&context, "!llvm.ptr").unwrap());
    }
    ...
    fn pointer_with_address_space() {
        ...
        assert_eq!(super::pointer(i32, 4), Type::parse(&context, "!llvm.ptr<i32, 4>").unwrap());
    }
    ...
    fn array() {
        ...
        assert_eq!(super::array(i32, 4), Type::parse(&context, "!llvm.array<4 x i32>").unwrap());
    }
