...
mod tests {
    ...
    fn integer() {
        ...
        assert_eq!(Type::integer(&context, 42), Type::parse(&context, "i42").unwrap());
    }
    ...
    fn signed_integer() {
        ...
        assert_eq!(Type::signed_integer(&context, 42), Type::parse(&context, "si42").unwrap());
    }
    ...
    fn unsigned_integer() {
        ...
        assert_eq!(Type::unsigned_integer(&context, 42), Type::parse(&context, "ui42").unwrap());
    }
    ...
    */
    ...
    fn vector_checked() {
        ...
        assert_eq!(
            Type::vector_checked(Location::unknown(&context), &[42], Type::integer(&context, 32)),
