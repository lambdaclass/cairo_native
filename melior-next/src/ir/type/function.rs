...
mod tests {
    ...
    fn input() {
        ...
        assert_eq!(Function::new(&context, &[integer], &[]).input(0), Ok(integer));
    }
    ...
    fn input_error() {
        ...
        assert_eq!(function.input(42), Err(Error::FunctionInputPosition(function.to_string(), 42)));
    }
    ...
    fn result() {
        ...
        assert_eq!(Function::new(&context, &[], &[integer]).result(0), Ok(integer));
    }
