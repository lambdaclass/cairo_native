...
impl<'c> Dialect<'c> {
    ...
    pub(crate) unsafe fn from_raw(dialect: MlirDialect) -> Self {
        Self { raw: dialect, _context: Default::default() }
    }
}
...
mod tests {
    ...
    fn equal() {
        ...
        assert_eq!(Handle::func().load_dialect(&context), Handle::func().load_dialect(&context));
    }
    ...
    fn not_equal() {
        ...
        assert_ne!(Handle::func().load_dialect(&context), Handle::llvm().load_dialect(&context));
    }
}
