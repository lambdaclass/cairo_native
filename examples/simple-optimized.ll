...
3:                                                ; preds = %2
  %4 = phi i256 [ %1, %2 ]
  %5 = call { i256, i256 } @"dup<felt252>"(i256 %4)
  %6 = extractvalue { i256, i256 } %5, 0
  %7 = extractvalue { i256, i256 } %5, 1
  %8 = call i256 @felt252_add(i256 %7, i256 2)
  %9 = call i256 @felt252_sub(i256 %6, i256 2)
  %10 = call { i256, i256 } @"struct_construct<Tuple<felt252, felt252>>"(i256 %8, i256 %9)
  %11 = call { i256, i256 } @"store_temp<Tuple<felt252, felt252>>"({ i256, i256 } %10)
  br label %12

12:                                               ; preds = %3
  %13 = phi { i256, i256 } [ %11, %3 ]
  store { i256, i256 } %13, ptr %0, align 4
  ret void
}
