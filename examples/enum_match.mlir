module attributes {llvm.data_layout = ""} {
  ...
  llvm.func internal @"enum_init<enum_match::enum_match::MyEnum, 1>"(%arg0: i16) -> !llvm.struct<(i16, array<4 x i8>)> {
  ...
  llvm.func @"enum_match::enum_match::get_my_enum_b"(%arg0: !llvm.struct<(i16, array<4 x i8>)>) -> i16 attributes {llvm.emit_c_interface} {
  ...
  llvm.func @"_mlir_ciface_enum_match::enum_match::get_my_enum_b"(%arg0: !llvm.struct<(i16, array<4 x i8>)>) -> i16 attributes {llvm.emit_c_interface} {
    %0 = llvm.call @"enum_match::enum_match::get_my_enum_b"(%arg0) : (!llvm.struct<(i16, array<4 x i8>)>) -> i16
    llvm.return %0 : i16
  }
  llvm.func @"enum_match::enum_match::main"() -> i16 attributes {llvm.emit_c_interface} {
    llvm.br ^bb1
  ^bb1:  // pred: ^bb0
  ...
  llvm.func @"_mlir_ciface_enum_match::enum_match::main"() -> i16 attributes {llvm.emit_c_interface} {
    %0 = llvm.call @"enum_match::enum_match::main"() : () -> i16
    llvm.return %0 : i16
  }
}
