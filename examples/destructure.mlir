module attributes {llvm.data_layout = ""} {
  ...
  llvm.func internal @"struct_construct<destructure::destructure::MyStruct>"(%arg0: i256, %arg1: i256, %arg2: i256) -> !llvm.struct<(i256, i256, i256)> {
  ...
  llvm.func internal @"struct_deconstruct<destructure::destructure::MyStruct>"(%arg0: !llvm.struct<(i256, i256, i256)>) -> !llvm.struct<(i256, i256, i256)> {
  ...
  llvm.func @"destructure::destructure::main"() -> !llvm.struct<()> attributes {llvm.emit_c_interface} {
    llvm.br ^bb1
  ^bb1:  // pred: ^bb0
  ...
  llvm.func @"_mlir_ciface_destructure::destructure::main"(%arg0: !llvm.ptr<struct<()>>) attributes {llvm.emit_c_interface} {
    %0 = llvm.call @"destructure::destructure::main"() : () -> !llvm.struct<()>
