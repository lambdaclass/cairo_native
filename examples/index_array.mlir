module attributes {llvm.data_layout = ""} {
  ...
  llvm.func internal @"enum_init<core::PanicResult::<(core::integer::u8)>, 0>"(%arg0: !llvm.struct<(i8)>) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, passthrough = ["norecurse", "alwaysinline", "nounwind"]} {
  ...
  ^bb1:  // pred: ^bb0
    ...
    llvm.store %arg0, %6 : !llvm.struct<(i8)>, !llvm.ptr
  ...
  llvm.func internal @"enum_init<core::PanicResult::<(core::integer::u8)>, 1>"(%arg0: !llvm.struct<(i32, i32, ptr)>) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, passthrough = ["norecurse", "alwaysinline", "nounwind"]} {
    %0 = llvm.mlir.constant(1 : i64) : i64
    %1 = llvm.alloca %0 x !llvm.struct<(i16, array<16 x i8>)> : (i64) -> !llvm.ptr
  ...
  llvm.func internal @"enum_init<core::PanicResult::<(core::box::Box::<@core::integer::u8>)>, 0>"(%arg0: !llvm.struct<(i8)>) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, passthrough = ["norecurse", "alwaysinline", "nounwind"]} {
    %0 = llvm.mlir.constant(1 : i64) : i64
    %1 = llvm.alloca %0 x !llvm.struct<(i16, array<16 x i8>)> : (i64) -> !llvm.ptr
    %2 = llvm.mlir.constant(0 : i16) : i16
    %3 = llvm.mlir.constant(0 : i16) : i16
  ...
  llvm.func internal @"enum_init<core::PanicResult::<(core::box::Box::<@core::integer::u8>)>, 1>"(%arg0: !llvm.struct<(i32, i32, ptr)>) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, passthrough = ["norecurse", "alwaysinline", "nounwind"]} {
    %0 = llvm.mlir.constant(1 : i64) : i64
    %1 = llvm.alloca %0 x !llvm.struct<(i16, array<16 x i8>)> : (i64) -> !llvm.ptr
    %2 = llvm.mlir.constant(1 : i16) : i16
    %3 = llvm.mlir.constant(0 : i16) : i16
  ...
  llvm.func @"index_array::index_array::main"() -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, llvm.emit_c_interface} {
    llvm.br ^bb4
  ^bb1:  // pred: ^bb4
  ...
  ^bb4:  // pred: ^bb0
    ...
    %22 = llvm.call @"core::array::ArrayIndex::<core::integer::u8>::index"(%20, %21) : (!llvm.struct<(i32, i32, ptr)>, i32) -> !llvm.struct<(i16, array<16 x i8>)>
    %23 = llvm.extractvalue %22[0] : !llvm.struct<(i16, array<16 x i8>)> 
    %24 = llvm.extractvalue %22[1] : !llvm.struct<(i16, array<16 x i8>)> 
    %25 = llvm.mlir.constant(1 : i64) : i64
    %26 = llvm.alloca %25 x !llvm.array<16 x i8> : (i64) -> !llvm.ptr
    llvm.store %24, %26 : !llvm.array<16 x i8>, !llvm.ptr
  ...
  ^bb5(%27: !llvm.struct<(i8)>):  // pred: ^bb1
    ...
    %30 = llvm.call @"enum_init<core::PanicResult::<(core::integer::u8)>, 0>"(%29) : (!llvm.struct<(i8)>) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.return %30 : !llvm.struct<(i16, array<16 x i8>)>
  ^bb6(%31: !llvm.struct<(i32, i32, ptr)>):  // pred: ^bb2
    %32 = llvm.call @"enum_init<core::PanicResult::<(core::integer::u8)>, 1>"(%31) : (!llvm.struct<(i32, i32, ptr)>) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.return %32 : !llvm.struct<(i16, array<16 x i8>)>
  }
  llvm.func @"_mlir_ciface_index_array::index_array::main"(%arg0: !llvm.ptr<struct<(i16, array<16 x i8>)>>) attributes {llvm.dso_local, llvm.emit_c_interface} {
    %0 = llvm.call @"index_array::index_array::main"() : () -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.store %0, %arg0 : !llvm.ptr<struct<(i16, array<16 x i8>)>>
    llvm.return
  }
  llvm.func @"core::array::ArrayIndex::<core::integer::u8>::index"(%arg0: !llvm.struct<(i32, i32, ptr)>, %arg1: i32) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, llvm.emit_c_interface} {
  ...
  ^bb4(%2: !llvm.struct<(i32, i32, ptr)>, %3: i32):  // pred: ^bb0
    %4 = llvm.call @"core::array::array_at::<core::integer::u8>"(%2, %3) : (!llvm.struct<(i32, i32, ptr)>, i32) -> !llvm.struct<(i16, array<16 x i8>)>
  ...
  ^bb5(%9: !llvm.struct<(i8)>):  // pred: ^bb1
    ...
    %12 = llvm.call @"enum_init<core::PanicResult::<(@core::integer::u8)>, 0>"(%11) : (!llvm.struct<(i8)>) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.return %12 : !llvm.struct<(i16, array<16 x i8>)>
  ^bb6(%13: !llvm.struct<(i32, i32, ptr)>):  // pred: ^bb2
    %14 = llvm.call @"enum_init<core::PanicResult::<(@core::integer::u8)>, 1>"(%13) : (!llvm.struct<(i32, i32, ptr)>) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.return %14 : !llvm.struct<(i16, array<16 x i8>)>
  }
  llvm.func @"_mlir_ciface_core::array::ArrayIndex::<core::integer::u8>::index"(%arg0: !llvm.ptr<struct<(i16, array<16 x i8>)>>, %arg1: !llvm.struct<(i32, i32, ptr)>, %arg2: i32) attributes {llvm.dso_local, llvm.emit_c_interface} {
    %0 = llvm.call @"core::array::ArrayIndex::<core::integer::u8>::index"(%arg1, %arg2) : (!llvm.struct<(i32, i32, ptr)>, i32) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.store %0, %arg0 : !llvm.ptr<struct<(i16, array<16 x i8>)>>
    llvm.return
  }
  llvm.func @"core::array::array_at::<core::integer::u8>"(%arg0: !llvm.struct<(i32, i32, ptr)>, %arg1: i32) -> !llvm.struct<(i16, array<16 x i8>)> attributes {llvm.dso_local, llvm.emit_c_interface} {
  ...
  ^bb3(%7: i8):  // pred: ^bb1
    ...
    %9 = llvm.call @"enum_init<core::PanicResult::<(core::box::Box::<@core::integer::u8>)>, 0>"(%8) : (!llvm.struct<(i8)>) -> !llvm.struct<(i16, array<16 x i8>)>
  ...
  ^bb4:  // pred: ^bb2
    ...
    %13 = llvm.call @"enum_init<core::PanicResult::<(core::box::Box::<@core::integer::u8>)>, 1>"(%12) : (!llvm.struct<(i32, i32, ptr)>) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.return %13 : !llvm.struct<(i16, array<16 x i8>)>
  }
  llvm.func @"_mlir_ciface_core::array::array_at::<core::integer::u8>"(%arg0: !llvm.ptr<struct<(i16, array<16 x i8>)>>, %arg1: !llvm.struct<(i32, i32, ptr)>, %arg2: i32) attributes {llvm.dso_local, llvm.emit_c_interface} {
    %0 = llvm.call @"core::array::array_at::<core::integer::u8>"(%arg1, %arg2) : (!llvm.struct<(i32, i32, ptr)>, i32) -> !llvm.struct<(i16, array<16 x i8>)>
    llvm.store %0, %arg0 : !llvm.ptr<struct<(i16, array<16 x i8>)>>
    llvm.return
  }
}
