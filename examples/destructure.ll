...
define internal { i256, i256, i256 } @"struct_construct<destructure::destructure::MyStruct>"(i256 %0, i256 %1, i256 %2) {
...
define internal { i256, i256, i256 } @"struct_deconstruct<destructure::destructure::MyStruct>"({ i256, i256, i256 } %0) {
