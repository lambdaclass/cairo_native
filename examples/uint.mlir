module attributes {llvm.data_layout = ""} {
  ...
  llvm.func internal @u128_wide_mul(%arg0: i128, %arg1: i128) -> !llvm.struct<(i128, i128)> {
    %0 = llvm.zext %arg0 : i128 to i256
  ...
  llvm.func @"uint::uint::main"() -> !llvm.struct<()> attributes {llvm.emit_c_interface} {
    llvm.br ^bb1
  ^bb1:  // pred: ^bb0
    ...
    %5 = llvm.call @u8_to_felt252(%0) : (i8) -> i256
    %6 = llvm.call @u16_to_felt252(%1) : (i16) -> i256
    %7 = llvm.call @u32_to_felt252(%2) : (i32) -> i256
    %8 = llvm.call @u64_to_felt252(%3) : (i64) -> i256
    %9 = llvm.call @u128_to_felt252(%4) : (i128) -> i256
    %10 = llvm.call @u8_wide_mul(%0, %0) : (i8, i8) -> i16
    %11 = llvm.call @u16_wide_mul(%1, %1) : (i16, i16) -> i32
    %12 = llvm.call @u32_wide_mul(%2, %2) : (i32, i32) -> i64
    %13 = llvm.call @u64_wide_mul(%3, %3) : (i64, i64) -> i128
  ...
  llvm.func @"_mlir_ciface_uint::uint::main"(%arg0: !llvm.ptr<struct<()>>) attributes {llvm.emit_c_interface} {
