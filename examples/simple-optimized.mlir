module attributes {llvm.data_layout = ""} {
  ...
  ^bb1(%1: i256):  // pred: ^bb0
    ...
    %4 = llvm.call @"struct_construct<Tuple<felt252, felt252>>"(%2, %3) : (i256, i256) -> !llvm.struct<(i256, i256)>
    llvm.return %4 : !llvm.struct<(i256, i256)>
  }
  ...
  ^bb1(%1: i256):  // pred: ^bb0
    ...
    %3 = llvm.call @felt252_sub(%1, %0) : (i256, i256) -> i256
    %4 = llvm.call @"struct_construct<Tuple<felt252, felt252>>"(%2, %3) : (i256, i256) -> !llvm.struct<(i256, i256)>
    llvm.br ^bb2(%4 : !llvm.struct<(i256, i256)>)
  ^bb2(%5: !llvm.struct<(i256, i256)>):  // pred: ^bb1
    llvm.store %5, %arg0 : !llvm.ptr<struct<(i256, i256)>>
    llvm.return
  }
}
