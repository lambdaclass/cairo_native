module attributes {llvm.data_layout = ""} {
  ...
  ^bb1(%1: i256):  // pred: ^bb0
    %2 = llvm.call @"dup<felt252>"(%1) : (i256) -> !llvm.struct<(i256, i256)>
    %3 = llvm.extractvalue %2[0] : !llvm.struct<(i256, i256)> 
    %4 = llvm.extractvalue %2[1] : !llvm.struct<(i256, i256)> 
    %5 = llvm.call @felt252_add(%4, %0) : (i256, i256) -> i256
    %6 = llvm.call @felt252_sub(%3, %0) : (i256, i256) -> i256
    %7 = llvm.call @"struct_construct<Tuple<felt252, felt252>>"(%5, %6) : (i256, i256) -> !llvm.struct<(i256, i256)>
  ...
  ^bb1(%1: i256):  // pred: ^bb0
    ...
    %7 = llvm.call @"struct_construct<Tuple<felt252, felt252>>"(%5, %6) : (i256, i256) -> !llvm.struct<(i256, i256)>
    %8 = llvm.call @"store_temp<Tuple<felt252, felt252>>"(%7) : (!llvm.struct<(i256, i256)>) -> !llvm.struct<(i256, i256)>
    llvm.br ^bb2(%8 : !llvm.struct<(i256, i256)>)
  ^bb2(%9: !llvm.struct<(i256, i256)>):  // pred: ^bb1
    llvm.store %9, %arg0 : !llvm.ptr<struct<(i256, i256)>>
    llvm.return
  }
}
