module attributes {llvm.data_layout = ""} {
  ...
  ^bb1(%0: i256):  // pred: ^bb0
    ...
    %5 = llvm.call @"struct_construct<Tuple<felt252, felt252>>"(%2, %4) : (i256, i256) -> !llvm.struct<packed (i256, i256)>
    llvm.return %5 : !llvm.struct<packed (i256, i256)>
  }
  llvm.func @"_mlir_ciface_simple::simple::something"(%arg0: !llvm.ptr<struct<packed (i256, i256)>>, %arg1: i256) attributes {llvm.dso_local, llvm.emit_c_interface} {
    %0 = llvm.call @"simple::simple::something"(%arg1) : (i256) -> !llvm.struct<packed (i256, i256)>
    llvm.store %0, %arg0 : !llvm.ptr<struct<packed (i256, i256)>>
    llvm.return
  }
}
