...
fn main() {
    ...
    let result = native_executor
        .execute_contract(
            fn_id,
            &[
                JITValue::Felt252(Felt252::from_bytes_be_slice(b"name")),
                JITValue::Felt252(Felt252::from_bytes_be_slice(b"symbol")),
                JITValue::Felt252(Felt252::from(0)),
                JITValue::Felt252(Felt252::from(i64::MAX)),
                JITValue::Felt252(Felt252::from(4)),
                JITValue::Felt252(Felt252::from(6)),
            ],
            u64::MAX.into(),
        )
