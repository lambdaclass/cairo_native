module attributes {llvm.data_layout = ""} {
  ...
  llvm.func @"destructure::destructure::main"() -> !llvm.struct<()> attributes {llvm.dso_local, llvm.emit_c_interface} {
    %0 = llvm.mlir.constant(56 : i256) : i256
    %1 = llvm.mlir.constant(34 : i256) : i256
    %2 = llvm.mlir.constant(12 : i256) : i256
    llvm.br ^bb1
  ^bb1:  // pred: ^bb0
    %3 = llvm.call @"struct_construct<destructure::destructure::MyStruct>"(%2, %1, %0) : (i256, i256, i256) -> !llvm.struct<(i256, i256, i256)>
